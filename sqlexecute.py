...
class SQLExecute(object):
	...
	def _connect(self, DBNAME):
		if 1:
			import pyodbc
			DB_IQ_UID=os.getenv('DB_IQ_UID')
			DB_IQ_PWD=os.getenv('DB_IQ_PWD')
			DB_IQ_DATABASE=os.getenv('DB_IQ_DATABASE')
			DB_IQ_SERVER=DBNAME
			assert DB_IQ_UID
			assert DB_IQ_PWD
			assert DB_IQ_DATABASE
			assert DB_IQ_SERVER

			conn_str=f'DSN={DB_IQ_SERVER};uid={DB_IQ_UID};pwd={DB_IQ_PWD};db={DB_IQ_DATABASE}' 
